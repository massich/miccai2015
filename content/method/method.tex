...
\begin{figure}[t]
    ...
    \caption {
      ...
      Highly saturated colouring indicates that low data cost when assigning the site to the label of this colour.
      (e) Pairwise term. Labeling configurations with more boundaries are penalized.}
